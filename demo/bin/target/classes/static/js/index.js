...
jsonp('https://api.map.baidu.com/api?v=2.0&ak=p216eDob1pGzTFpzf5k4xYjX6EyjuiKA&s=1&callback=getCity');
    ...
    for (var i = 0; i < aDiv.length; i++) {
        ...
        option = {
            ...
            xAxis: {
                type: 'category',
                boundaryGap: false,
                data: [data[0].week, data[1].week, data[2].week, data[3].week, data[4].week, data[5].week]
            },
            yAxis: {
                type: 'value'
            },
            series: [
                {
                    ...
                    type: 'line',
                    stack: '温度',
                    data: [(data[0].temperature).split("℃/")[0], (data[1].temperature).split("℃/")[0], (data[2].temperature).split("℃/")[0], (data[3].temperature).split("℃/")[0], (data[4].temperature).split("℃/")[0], (data[5].temperature).split("℃/")[0]]
                },
                {
                    name: '最低',
                    type: 'line',
                    stack: '温度',
                    data: [(data[0].temperature.split("/")[1]).split("℃")[0], (data[1].temperature.split("/")[1]).split("℃")[0], (data[2].temperature.split("/")[1]).split("℃")[0], (data[3].temperature.split("/")[1]).split("℃")[0],(data[4].temperature.split("/")[1]).split("℃")[0], (data[5].temperature.split("/")[1]).split("℃")[0]]
                }
            ]
        };
        ;
...
function chooseImg(id, index) {
    switch (id) {
        case '1':
            index.src = 'http://localhost:8080/images/weather_icon/1.png';
            break;
        case '2':
            index.src = 'http://localhost:8080/images/weather_icon/2.png';
            break;
        case '3':
            index.src = 'http://localhost:8080/images/weather_icon/3.png';
            break;
        case '4':
        case '5':
        case '6':
        ...
        case '25':
        case '26':
            index.src = 'http://localhost:8080/images/weather_icon/4.png';
            break;
        case '7':
            index.src = 'http://localhost:8080/images/weather_icon/6.png';
            break;
        case '14':
        case '15':
        case '16':
        ...
        case '28':
        case '29':
            index.src = 'http://localhost:8080/images/weather_icon/5.png';
            break;
        case '19':
        case '21':
        case '30':
        ...
        case '32':
        case '33':
            index.src = 'http://localhost:8080/images/weather_icon/7.png';
            break;
        default:
            index.src = 'http://localhost:8080/images/weather_icon/8.png';
    }
}
